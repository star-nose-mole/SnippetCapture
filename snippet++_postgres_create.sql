...
CREATE TABLE public.user (
  ...
  -- chkpass a module that implements a data type chkpass that is designed for storing encrypted passwords.Each password is automatically converted to encrypted form upon entry, and is always stored encrypted. 
	CONSTRAINT "user_pk" PRIMARY KEY ("_id")
) WITH (
  OIDS=FALSE
);

CREATE TABLE public.userSnippets ( 
	"_id" serial NOT NULL,
	"user_id" bigint NOT NULL,
	"snippet_id" bigint NOT NULL,
	CONSTRAINT "userSnippets_pk" PRIMARY KEY ("_id")
) WITH (
  OIDS=FALSE
);
...
CREATE TABLE public.snippets (
	...
	"snippetCode" varchar NOT NULL, 
	CONSTRAINT "snippet_pk" PRIMARY KEY ("_id")
) WITH (
  OIDS=FALSE
);


CREATE TABLE public.snippetTags (
	"_id" serial NOT NULL,
	"snippet_id" bigint NOT NULL,
  "tag_id" bigint NOT NULL,
	CONSTRAINT "snippetTag_pk" PRIMARY KEY ("_id")
) WITH (
  OIDS=FALSE
);
...
ALTER TABLE public.snippetTags ADD CONSTRAINT "userSpippets_fk0" FOREIGN KEY ("user_id") REFERENCES  public.users("_id");
ALTER TABLE public.userSnippets ADD CONSTRAINT "userSpippets_fk1" FOREIGN KEY  ("snippet_id") REFERENCES  public.snippets("_id");

ALTER TABLE public.snippetTags ADD CONSTRAINT "snippetTags_fk0" FOREIGN KEY ("snippet_id") REFERENCES  public.users("_id");
ALTER TABLE public.snippetTags ADD CONSTRAINT "snippetTags_fk1" FOREIGN KEY  ("tag_id") REFERENCES  public.snippets("_id");



INSERT INTO public.user VALUES (1, "keyboardFanatic", "keyboard");
INSERT INTO public.user VALUES (2, "frandering", "siracha123");
INSERT INTO public.user VALUES (3, "master", "master");
INSERT INTO public.user VALUES (4, "bbygorl", "ian");
INSERT INTO public.user VALUES (5, "mochi", "treaties");
...
INSERT INTO public.userSnippets VALUES (1, 1, 4);
INSERT INTO public.userSnippets VALUES (2, 2, 1);
INSERT INTO public.userSnippets VALUES (3, 3, 3);
INSERT INTO public.userSnippets VALUES (4, 4, 2);
INSERT INTO public.userSnippets VALUES (5, 5, 5);
...
INSERT INTO public.snippetTags VALUES (1, 1, 1);
INSERT INTO public.snippetTags VALUES (2, 1, 8);
INSERT INTO public.snippetTags VALUES (3, 2, 5);
INSERT INTO public.snippetTags VALUES (4, 2, 6);
INSERT INTO public.snippetTags VALUES (5, 2, 7);
INSERT INTO public.snippetTags VALUES (6, 3, 3);
INSERT INTO public.snippetTags VALUES (7, 3, 4);
INSERT INTO public.snippetTags VALUES (8, 3, 9);
INSERT INTO public.snippetTags VALUES (9, 4, 2);
INSERT INTO public.snippetTags VALUES (10, 1, 10);
INSERT INTO public.snippetTags VALUES (11, 1, 11);
